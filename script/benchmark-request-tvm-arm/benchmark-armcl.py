...
# ReQuEST description (this is reused from ArmCL OpenCL submission)
request_dict={
...
#        use_lib_tags = [ 'request-d8f69c13', '18.03-e40997bb', '18.01-f45d5a9b', '17.12-48bc34ea' ]
    ...
    ii={'action':'pipeline',
        ...
        'deps.compiler':'37f92184481a045c',
...
#        if arg.accuracy and lib_tags not in use_lib_tags: continue
        ...
        for model_uoa in udepm:
            ...
            record_repo='local'
            record_uoa='ck-request-asplos18-mobilenets-tvm-arm-'+experiment_type+'-'+str(rho)+'-'+str(alpha)+'-armcl-opencl-'+lib_tags
